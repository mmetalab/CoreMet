...
Reads the canonical v3 database CSVs and writes data/coremetdb_stats.json.
...
DB_CONFIG = {
    "MPI": {
        ...
        "path": DATA_DIR / "mpidatabase" / "MPIDB_v3.csv",
        "metabolite": "HMDB ID",
        "target": "Uniprot ID",
    ...
    "MEI": {
        ...
        "path": DATA_DIR / "databases" / "mei_database_v2_enriched.csv",
        "metabolite": "HMDB_ID",
        "target": "EC_Number",
    ...
    "MDI": {
        ...
        "path": DATA_DIR / "databases" / "mdi_database_v3.csv",
        "metabolite": "HMDB_ID",
        "target": "Disease_Name",
    ...
    "MMI": {
        ...
        "path": DATA_DIR / "databases" / "mmi_database_v3.csv",
        "metabolite": "HMDB_ID",
        "target": "Microbe_Name",
    ...
    "MDrI": {
        ...
        "path": DATA_DIR / "databases" / "mdri_database_v3.csv",
        "metabolite": "HMDB_ID",
        "target": "Drug_Name",
        "target_label": "drugs",
        "organism": None,
    ...
    "MGI": {
        ...
        "path": DATA_DIR / "databases" / "mgi_database_v3.csv",
        "metabolite": "HMDB_ID",
        "target": "Gene_Symbol",
        "target_label": "genes",
        "organism": "Organism",
    ...
    "mGWAS": {
        ...
        "path": DATA_DIR / "databases" / "mgwas_database_v3.csv",
        "metabolite": "HMDB_ID",
        "target": "rsID",
        "target_label": "SNPs",
        "organism": None,
...
def main() -> None:
    print("Computing CoreMet statistics from canonical v3 CSVs ...")
    ...
    stats = {
        ...
        "_note": (
            "Generated by scripts/compute_db_stats.py from canonical v3 CSVs. "
            "Do not hand-edit. 'curated_disease_networks' (130) is the disease-network "
            "explorer count and is DISTINCT from MDI 'diseases' (raw target count)."
        ),
    }
